...
@Service
@Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.REPEATABLE_READ, timeout = 5, readOnly = false, rollbackFor = {
		ArithmeticException.class }, noRollbackFor = { RuntimeException.class })
